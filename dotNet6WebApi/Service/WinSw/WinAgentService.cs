...
namespace Service.WinSw
{


    public class WinAgentService : ServiceBase
    {
        public Func<WebApplication> StartAct { get; set; }

        #region 构造函数
        /// <summary>实例化一个代理服务</summary>
        public WinAgentService()
        {
            // 一般在构造函数里面指定服务名
            ServiceName = "dotNet6WebApi";

            DisplayName = "dotNet6WebApi服務";
            Description = "dotNet6WebApi服務，請不要關閉！";
        }
