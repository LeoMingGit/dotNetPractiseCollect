...
namespace EfCoreTest.Common
{
    public static class EfCoreHelper
    {
        ...
        /// <returns></returns>
        public static List<T> ExecutePaginationSqlRtnList<T>(DbContext ctx, List<SqlParameter> listParam, string sql, string sort, int limit, int page)
        {
            DataTable dt = ExecutePaginationSqlRtnDataTable(ctx, listParam, sql, sort, limit, page);
        ...
        /// <param name="page"></param>
        /// <returns></returns>
        public static DataTable ExecutePaginationSqlRtnDataTable(DbContext ctx, List<SqlParameter> listParam, string sql, string sort, int limit, int page)
        {
        ...
        /// <param name="sql"></param>
        /// <returns></returns>
        public static int ExecuteCountSql(DbContext ctx, List<SqlParameter> listParam, string sql)
        {
